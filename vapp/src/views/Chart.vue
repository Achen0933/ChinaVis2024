  ...
  methods: {
    ...
    drawChart(letter) {
      ...
      const option = {
        ...
        parallelAxis: [
          { dim: 0, name: '名称', nameLocation: 'end', nameTextStyle: { color: 'white' }, nameGap: 30, nameRotate: 0 },
          { dim: 1, name: '年薪', min: 0, nameLocation: 'end', nameTextStyle: { color: 'white' }, nameGap: 30, nameRotate: 0 },
          { dim: 2, name: '经验', min: 1, max: 3, nameLocation: 'end', nameTextStyle: { color: 'white' }, nameGap: 30, nameRotate: 0 },
          { dim: 3, name: '教育', min: 1, max: 3, nameLocation: 'end', nameTextStyle: { color: 'white' }, nameGap: 30, nameRotate: 0 },
          { dim: 4, name: '行业', min: 1, max: 3, nameLocation: 'end', nameTextStyle: { color: 'white' }, nameGap: 30, nameRotate: 0 }
        ],
        parallel: {
          left: '5%',
          right: '18%',
        ...
        series: [
          {
            ...
            lineStyle: {
              ...
              color: {
                ...
                y2: 1,
                colorStops: [
                  { offset: 0, color: '#516b91' },
                  { offset: 1, color: '#59c4e6' }
                ]
              }
            },
            data: formattedData
